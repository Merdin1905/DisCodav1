...
module.exports = async member => {  
 ...
 const ctx = canvas.getContext('2d');
  ...
  const background = await Canvas.loadImage('https://cdn.discordapp.com/attachments/761962651944878088/767012718204026890/cks.png');
 ...
 ctx.drawImage(avatar, 112, 55, 110, 110);
  ...
  const attachment = new Discord.Attachment(canvas.toBuffer(), 'cks.png');
